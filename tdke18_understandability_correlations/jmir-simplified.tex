...
Unless explicitly stated otherwise, we ignored out of vocabulary (OV) words in the feature calculations \todo{10 - How were the features calculated?} .
...
%of the different scoring strategies and distributions employed when scoring for relevance compared to for understandability \todo{16 - Confusing sentence. }. 
