...
\author{Joao~Palotti,%~\IEEEmembership{Member,~IEEE,}
        ~Guido~Zuccon,%~\IEEEmembership{Fellow,~OSA,}
        ~and~Allan~Hanbury%~\IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem J. Palotti and A. Hanbury are with Vienna University of Technology, Vienna, Austria.
\protect\\
Email: {palotti,hanbudy}@ifs.tuwien.ac.at
% note need leading \protect in front of \\ to get a newline within \thanks as
% \\ is fragile and will error, could use \hfil\break instead.
\IEEEcompsocthanksitem G. Zuccon is with Queensland University of Technology, Brisbane, Australia.% <-this % stops an unwanted space
\protect\\
Email: g.zuccon@qut.edu.au
}
\thanks{Manuscript submitted March 1, 2017}}
%\thanks{Manuscript received March 1, 2017; revised August 26, 2015.}}
...
\markboth{Paper under revision to the IEEE Transactions on Knowledge and Data Engineering}%
{Shell \MakeLowercase{\textit{et al.}}: Bare Demo of IEEEtran.cls for Computer Society Journals}
...
\begin{IEEEkeywords}
Information Retrieval, User Behaviour, System Evaluation, Document Understandability.
\end{IEEEkeywords}}
...
\begin{IEEEbiography}{Joao Palotti}
Biography text here.
\end{IEEEbiography}

% if you will not have a photo at all:
\begin{IEEEbiographynophoto}{Guido Zuccon}
Biography text here.
...
\begin{IEEEbiographynophoto}{Allan Hanbury}
Biography text here.
\end{IEEEbiographynophoto}
