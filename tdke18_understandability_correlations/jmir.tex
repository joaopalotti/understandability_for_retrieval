...
~\\\textsuperscript{2}{Queensland University of Technology\unskip, Brisbane\unskip, Australia} %, Email: g.zuccon@qut.edu.au
...
Australia\\
Phone:  (+61) 07 3138 1412\\
Email: \href{mailto:g.zuccon@qut.edu.au}{g.zuccon@qut.edu.au}
}
...
\textbf{Results:} We found that machine learning techniques were more suitable to estimate health Web page understandability than traditional readability formulas, which are often used as guidelines and benchmarking by health information providers on the Web (\todo{p value}). Learning to rank effectively exploited these estimates to provide the general public with more understandable search results (\todo{significant improvements over XXX, p-value}).
...
\input{jmir_sections/introduction}
\input{jmir_sections/methods}
\input{jmir_sections/results}
\input{jmir_sections/discussion}
