...
\cline{4-5} 
 & \# of determiners $^{\star\diamondsuit\dagger}$ & & \multirow{7}{*}{\textbf{MLR}} & Linear Regressor\tabularnewline  
 ...
 & \# of Entities $^{\star\diamondsuit\dagger}$ &  &  & eXtreme Gradient Boosting (XGB) regressor\tabularnewline
 & Height of part-of-speech parser tree $^{\star\diamondsuit\dagger}$ &  &  & Logistic Regression\tabularnewline
 \cline{4-5} 
 & \# of Stopwords $^{\star\diamondsuit\dagger}$ &  &   \multirow{5}{*}{\textbf{MLC}} & Multi-layer Perceptron Classifier\tabularnewline
