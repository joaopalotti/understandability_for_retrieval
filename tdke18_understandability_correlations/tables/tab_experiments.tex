...
indices 1-3 the index column is labelled I). Re-ranking experiments are reported at indices 4-21.
...
up to rank $n=10$. \todo{say what the bolding is for.} }
%\vspace{-0.2cm}
 \label{tab:experiments} 
\resizebox{1.00\textwidth}{!}{ %
\begin{tabular}{cclllllllllllll}
\toprule 
    \multirow{2}{*}{I}  & \multirow{2}{*}{Rerank }  & \multirow{2}{*}{Run }  & \multicolumn{4}{l}{Official CLEF 2016 Metrics} & \multicolumn{8}{l}{New Metrics to Evaluate Understability in Retrieval}\tabularnewline
