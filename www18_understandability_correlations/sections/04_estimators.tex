...
These include commonly used natural language heuristics such as the ratio of part-of-speech (POS) classes, %the number of entities in the text, 
...
\item \underline{PubMed Central:} PubMed Central~\cite{pubmed} is an online  database of %freely available 
    full-text biomedical literature. We used the collection distributed for the TREC 2014 and 2015 Clinical Decision Support Track~\cite{roberts16,trec15}, consisting of 733,191 articles. 
