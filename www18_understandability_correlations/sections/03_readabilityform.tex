...
\begin{itemize}
    ...
    \item $HP_{ru}@n = 2 \times \frac{P_r@n \times P_u@n}{P_r@n + P_u@n}$: combines the two previous precision-based measures into a unique measurement using the harmonic mean (in the same fashion that $F_1$ measure combines recall and precision).
\end{itemize}
