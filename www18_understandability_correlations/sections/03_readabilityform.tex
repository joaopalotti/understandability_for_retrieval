...
As this paper proposes an extensive understandability evaluation, we were obliged to only present here a carefully selection of our results.
We invite the reader to visit \textbf{\url{https://sites.google.com/view/www2018-sub34}} to see our complimentary results\footnote{The data and code created for this paper will also be available at GitHub.}.
