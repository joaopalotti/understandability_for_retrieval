...
\begin{figure*}[h!]
   \vspace{-0.2cm}
   \centering
   \includegraphics[width=0.55\textwidth]{graphics/box_spearman15_raw_values_joao}\vspace{-7pt}
   \includegraphics[width=0.55\textwidth]{graphics/box_spearman16_raw_values_joao}
