\begin{table}[tb]
\caption{Methods used to estimate understandability. $\star$: raw values were used. $\diamondsuit$: values normalised by number of words in a documents were used. $\dagger$: values normalised by number of sentences in a document were used.}
