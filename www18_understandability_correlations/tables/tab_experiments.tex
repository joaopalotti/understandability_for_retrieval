...
rank experiments are reported at indices 25-27. All metrics were calculated
up to rank 10.}
\label{tab:experiments} \resizebox{1.0\textwidth}{!}{ %
\begin{tabular}{cclllllllllll}
\toprule 
    \multirow{2}{*}{Index } & \multirow{2}{*}{Rerank } & \multirow{2}{*}{Run } & \multicolumn{3}{l}{Official CLEF 2016 Metrics} & \multicolumn{7}{l}{New Metrics to Evaluate Understandability in Retrieval - Sec.~\ref{sec:data}}\tabularnewline
    \cmidrule(l{2pt}r{2pt}){4-6} \cmidrule(l{2pt}r{2pt}){7-13} 
    &  &  & $RBP$  & uRBP  & $uRBP^{*}$  & $RBP_{r}$  & $RBP_{u}$  & $H_{ru}$  & Unj  & $RBP_{r}^*$  & $RBP_{u}^*$  & $H_{ru}^*$\tabularnewline
\midrule 
1  & \multirow{3}{*}{No Rerank} & GUIR~\cite{soldaini16} (Best Run)  & 28.11  & 18.12  & 18.22  & 28.11  & 45.69  & 25.61  & 0.01  & 28.29  & 46.03  & 25.79 \tabularnewline
2  &  & ECNU~\cite{song16} (Runner Up)  & 27.70  & 17.55  & 17.61  & 27.70  & 43.89$^{\diamond}$  & 25.35  & 0.01  & 27.77  & 44.18$^{\diamond}$  & 25.48 \tabularnewline
3  &  & Plain BM25 Baseline  & 25.28$^{\diamond}$  & 16.05$^{\diamond}$  & 16.46$^{\diamond}$  & 25.28$^{\diamond}$  & 42.08$^{\diamond}$  & 22.97$^{\diamond}$  & 0.06  & 26.01$^{\diamond}$  & 43.89$^{\diamond}$  & 23.93$^{\diamond}$ \tabularnewline
\midrule 
4  & \multirow{3}{*}{Dale-Chall Top 20} & Based on GUIR  & 22.19$^{\dagger\diamond}$  & 15.36$^{\dagger\diamond}$  & 16.10$^{\dagger\diamond}$  & 22.19$^{\dagger\diamond}$  & 48.71$^{\dagger\diamond}$  & 23.21$^{\dagger\diamond}$  & 0.06  & 23.26$^{\dagger\diamond}$  & 51.39$^{\dagger\diamond}$  & 24.45$^{\dagger\diamond}$\tabularnewline
5  &  & Based on ECNU  & 23.01$^{\dagger\diamond}$  & 15.70$^{\dagger\diamond}$  & 16.24$^{\diamond}$  & 23.01$^{\dagger\diamond}$  & 48.99$^{\dagger\diamond}$  & 23.73$^{\dagger\diamond}$  & 0.05  & 23.84$^{\dagger\diamond}$  & 51.00$^{\dagger\diamond}$  & 24.66\tabularnewline
6  &  & Based on BM25 Baseline  & 21.58$^{\dagger\diamond}$  & 14.83$^{\dagger\diamond}$  & 15.65$^{\diamond}$  & 21.58$^{\dagger\diamond}$  & 46.99$^{\dagger}$  & 22.89$^{\diamond}$  & 0.09  & 22.93$^{\dagger\diamond}$  & 49.55$^{\dagger\diamond}$  & 24.26\tabularnewline
\midrule 
7  & \multirow{3}{*}{XGB Top 15} & Based on GUIR  & 25.16$^{\dagger\diamond}$  & 17.27$^{\dagger\diamond}$  & 17.58  & 25.16$^{\dagger\diamond}$  & 50.96$^{\dagger\diamond}$  & 25.16  & 0.02  & 25.61$^{\dagger\diamond}$  & 52.00$^{\dagger\diamond}$  & 25.68\tabularnewline
