...
\cmidrule(l{2pt}r{2pt}){4-7} \cmidrule(l{2pt}r{2pt}){8-14}  &  &  & $RBP$  & uRBP  & $uRBP^{*}$  & Res & $RBP_{r}$  & $RBP_{u}$  & $HRBP_{ru}$  & Unj  & $RBP_{r}^{*}$  & $RBP_{u}^{*}$  & $HRBP_{ru}^{*}$\tabularnewline
\midrule 
1  & \multirow{3}{*}{No Rerank}  & GUIR~\cite{soldaini16} (Best Run)  & 28.11  & 18.12  & 18.22  & 7.65 & 28.11  & 45.69  & 25.61  & 0.01  & 28.29  & 46.03  & 25.79 \tabularnewline
2  &  & ECNU~\cite{song16} (Runner Up)  & 27.70  & 17.55  & 17.61  & 7.37 & 27.70  & 43.89$^{\diamond}$  & 25.35  & 0.01  & 27.77  & 44.18$^{\diamond}$  & 25.48 \tabularnewline
3  &  & Plain BM25 Baseline  & 25.28$^{\diamond}$  & 16.05$^{\diamond}$  & 16.46$^{\diamond}$  & 8.24 & 25.28$^{\diamond}$  & 42.08$^{\diamond}$  & 22.97$^{\diamond}$  & 0.06  & 26.01$^{\diamond}$  & 43.89$^{\diamond}$  & 23.93$^{\diamond}$ \tabularnewline
\midrule 
4  & \multirow{3}{*}{Dale-Chall Top 20}  & Based on GUIR  & 22.19$^{\dagger\diamond}$  & 15.36$^{\dagger\diamond}$  & 16.10$^{\dagger\diamond}$  & 9.37 & 22.19$^{\dagger\diamond}$  & 48.71$^{\dagger\diamond}$  & 23.21$^{\dagger\diamond}$  & 0.06  & 23.26$^{\dagger\diamond}$  & 51.39$^{\dagger\diamond}$  & 24.45$^{\dagger\diamond}$\tabularnewline
5  &  & Based on ECNU  & 23.01$^{\dagger\diamond}$  & 15.70$^{\dagger\diamond}$  & 16.24$^{\diamond}$  & 8.93 & 23.01$^{\dagger\diamond}$  & 48.99$^{\dagger\diamond}$  & 23.73$^{\dagger\diamond}$  & 0.05  & 23.84$^{\dagger\diamond}$  & 51.00$^{\dagger\diamond}$  & 24.66\tabularnewline
6  &  & Based on BM25 Baseline  & 21.58$^{\dagger\diamond}$  & 14.83$^{\dagger\diamond}$  & 15.65$^{\diamond}$  & 9.51 & 21.58$^{\dagger\diamond}$  & 46.99$^{\dagger}$  & 22.89$^{\diamond}$  & 0.09  & 22.93$^{\dagger\diamond}$  & 49.55$^{\dagger\diamond}$  & 24.26\tabularnewline
\midrule 
