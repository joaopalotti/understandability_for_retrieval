...
\toprule 
\multirow{2}{*}{\textbf{Group} } & \multicolumn{5}{c|}{\textbf{CLEF eHealth 2015}} & \multicolumn{5}{c}{\textbf{CLEF eHealth 2016}}\tabularnewline
\cmidrule{2-11} 
 & \textbf{Metric}  & \textbf{Preproc.}  & \textbf{Pears.}  & \textbf{Spear.}  & \textbf{Kend.} & \textbf{Metric}  & \textbf{Preproc.}  & \textbf{Pears.}  & \textbf{Spear.}  & \textbf{Kend.}\tabularnewline
\midrule 
